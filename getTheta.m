...
% Given the vector components x and y,
% compute the angle of a vector counter clockwise from the x axis by breaking the problem into two
% parts: on and off axis. 
